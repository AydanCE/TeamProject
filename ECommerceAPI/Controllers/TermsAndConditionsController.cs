...
namespace ECommerceAPI.Controllers
{
    ...
    {
        private readonly ITermsAndConditionService _pageService;

        public TermsAndConditionsController(ITermsAndConditionService pageService)
        {
            _pageService = pageService;
        }

        [HttpPost("Add")]
        public IActionResult Add(TermsAndCondition page)
        {
        ...
        [HttpPost("Update")]
        public IActionResult Update(TermsAndCondition page)
        {
