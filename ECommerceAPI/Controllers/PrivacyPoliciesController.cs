...
namespace ECommerceAPI.Controllers
{
    ...
    {
        private readonly IPrivacyPolicyService _pageService;

        public PrivacyPoliciesController(IPrivacyPolicyService pageService)
        {
            _pageService = pageService;
        }

        [HttpPost("Add")]
        public IActionResult Add(PrivacyPolicy page)
        {
        ...
        [HttpPost("Update")]
        public IActionResult Update(PrivacyPolicy page)
        {
